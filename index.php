                                    ...
                                    <div class="hero-card p1-xxl-bg pt-xl-20 pb-xl-20 position-relative">
                                        <div class="pt-xxl-10 pb-xxl-10">
                                            ...
                                            <span class="heading p1-max-xxl nb4-xxl-color fs-five mb-3">Master the
                                                Markets</span>
                                            <h1 class="display-two nb4-xxl-color mb-5 mb-lg-6">Trade Smart With AI
                                                Trading And
                                                Make Profit
                                            </h1>
                                            <p class="fs-six-up fw_500 nb4-xxl-color">TradingEra helps you trade smarter
                                                with
                                            ...
                                            <div
                                                ...
                                                <a href="signin.html"
                                                    class="cmn-btn link link-xxl-color fs-five  gap-2 gap-lg-3 align-items-center "><i
                                                        class="ti ti-arrow-narrow-right fs-four"></i> Try demo
                                                    account</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6 col-xxl-7">
                                    <div class="hero-card hero-card2 p1-xxl-bg2 pt-xl-20 pb-xl-20 position-relative">
                                        <div class="pt-xxl-10 pb-xxl-10">
                                            ...
                                            <p class="fs-six-up fw_500 nb4-xxl-color" style="transform: scaleX(-1);">
                                                Trade
                                        ...
                                        mt-lg-10">
                                                ...
                                                <a href="signin.html"
                                                    ...
                                                    style="transform: scaleX(-1);"><i
                                                        class="ti ti-arrow-narrow-right fs-four"></i>
                                                    Try demo account</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-10 d-flex align-items-center">
                                            <div class="row">
                                                ...
                                                <span> Customized funding to your needs & your investment
                                                    journey.</span>
                                            </div>
                    ...
                    <div class="col-md-10 col-lg-6 col-xxl-5">
                        <div class="trade_on__content">
                            ...
                            <p class="mx-ch">Web trading platforms are safer since they use a remote server or cloud for
                                calculations. Users only need to focus on their internet connection and routing speed.
                                No need
                        ...
                        <ul class="d-flex gap-4 flex-column mt-6">
                            <li class="d-flex align-items-center gap-3 fs-six-up"><i
                                    class="ti ti-circle-check s1-color fs-four"></i>Accessible anytime and anywhere, no
                                need for
                                installation.

                            </li>
                            <li class="d-flex align-items-center gap-3 fs-six-up"><i
                                    class="ti ti-circle-check s1-color fs-four"></i>Cross-Device Compatibility, Works
                                across
                                multiple devices.
                            </li>
                            <li class="d-flex align-items-center gap-3 fs-six-up"><i
                            ...
                            <li class="d-flex align-items-center gap-3 fs-six-up"><i
                                    class="ti ti-circle-check s1-color fs-four"></i>No need for high-end hardware,
                                suitable for
                                various devices.</li>
                            <li class="d-flex align-items-center gap-3 fs-six-up"><i
                                    class="ti ti-circle-check s1-color fs-four"></i>Compatible across various operating
                                systems.
                            </li>
                            <li class="d-flex align-items-center gap-3 fs-six-up"><i
                                    class="ti ti-circle-check s1-color fs-four"></i>Requires minimal disk space as data
                                is
                                stored in the cloud.
                ...
                <div class="row gy-10 gy-xxl-0 justify-content-center justify-content-xxl-between align-items-center">
                    <div class="col-md-10 col-lg-6 col-xxl-5">
                        <div class="trade_on__content">
                            ...
                            <h4 class="mb-4 mb-lg-5" style="font-size: 32px;">Trade Anywhere, Anytime with TradersEra
                                App</h4>
                            <p class="mx-ch">Don't let trading opportunities slip away.</p>
                            <br>
                            <p class="mx-ch">Download the TradersEra Trader app for commission-free trading and
                                ultra-low
                            ...
                            <div class="col-4 mt-4" style="display: flex; justify-content: space-evenly; ">
                                <img style="border:1px solid white; border-radius:10px;"
                                    src="assets/images/_app store.png">
                        ...
                        <div class="row ms-xl-3 ms-xxl-10">
                            <div class="col-xxl-12">
                                <div class="">
                                    ...
                                    <br>
                                    <p>
                                        At TradersEra we've got all your account funding needs sorted. Whether you fancy
                                        the
                                        ease of Visa or Mastercard, the trustworthiness of a wire transfer or the modern
                                        touch
                                        of cryptocurrency we offer a range of options to kick off smoothly. Pick the
                                        approach
                            ...
                            <<<<<<< HEAD <ul class=" d-flex   gap-md-3 mt-4">
                                <li><img style=" height:35px;" src="assets/images/icon/a. Wire Transfer white logo.png">
                                </li>
                                =======

                                <ul class=" d-flex   gap-md-3 mt-4">
                                    <li><img style=" height:35px;" src="assets/images/icon/a. visa white _logo.png">
                                    </li>

                                    >>>>>>> 6e6ef090bcbaac65e027e915ab617b9e83e47478
                                    <li><img style=" height:35px;" src="assets/images/icon/a. mastercard.png"></li>

                                    <li><img style=" height:35px;"
                                            src="assets/images/icon/a. Wire Transfer white logo.png"></li>

                                    <li><img style=" height:35px;" src="assets/images/icon/a .crypto logo.png"></li>
                                    <<<<<<< HEAD <li><img style=" height:35px;"
                                            src="assets/images/icon/a. visa white _logo.png"></li>
