...
<head>
    ...
    <title>Forex Trading India | MT5 | UTIP Trading Platform</title>
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta name="description"
        content="Experience the power of MT5 and UTIP Trading Platform. Become a partner with our forex IB program. Start trading now!" />
    <meta name="keywords"
        content="Online Forex Trading, UTIP Trading Platform, MT5, Meta Trader 5, India, Become a Partner, forex ib program, Best Forex Broker India, Forex Introducing Brokers, 
        Trading Account Forex, Forex Equinix Data Center, Equinix Server, Forex Leverage, Equinix Server, Equinix London" />
    <!-- Favicon -->
...
<body data-spy="scroll" data-offset="80">
                ...
                <div class="row justify-content-md-center">
                    <div class="col-lg-12">
                        <div class="banner-text text-center text-white">
                            ...
                            <br>
                            <br>
                            <h1 class="text-white iq-tw-7 iq-mb-17">Explore Best Trading Platform With Various
                                Investment Options In
                                <b class="iq-font-yellow">India</b>
                            </h1>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="fancy-box">
                        ...
                        <br>
                        <p>
                        <h5>Predict asset movements within set time frames.</h5>
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 r9-mt-40">
                    <div class="fancy-box">
                        ...
                        <br>
                        <p>
                        <h5>Know potential profits and losses upfront.</h5>
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 r9-mt-40">
                                        ...
                                        <div class="iq-blog-box">
                                            ...
                                            <div class="iq-blog-detail">
                                                ...
                                                <div class="blog-content">
                                                    <p>
                                                        TradersEra offers diverse trading options, including
                                                        cryptocurrency, FX, and traditional assets, to help Indian and
                                                        International clients diversify portfolios and profit from
                                                        market trends.
                                                    </p>
                                                    <br>
                                                </div>
                                            ...
                                            <div class="iq-blog-detail">
                                                ...
                                                <div class="blog-content">
                                                    <p>TradersEra focuses on user experience with its easy-to-use
                                                        ...
                                                        for seamless navigation and fast transactions.
                                                    </p>
                                                    <br>
                                                </div>
                                            </div>
            ...
            <div class="row">
                <div class="col-lg-12 r9-mt-40">
                    <div class="iq-accordion">
                        <div class="iq-ad-block ad-active"> <a href="javascript:void(0)" class="ad-title">How do I get
                                started with TradersEra?</a>
                            <div class="ad-details">Getting started is easy! Simply sign up for an account on our
                                website, and you'll be guided through the account registration process step by step.
                            </div>
                        </div>
                        <div class="iq-ad-block"> <a href="javascript:void(0)" class="ad-title">What documents do I need
                                to provide to open an account?</a>
                            <div class="ad-details">To comply with regulatory requirements, we'll need some basic
                                identification documents such as a passport or driver's license, as well as proof of
                                address.</div>
                        </div>
                        <div class="iq-ad-block"> <a href="javascript:void(0)" class="ad-title">Is my personal
                                information safe with TradersEra?</a>
                            <div class="ad-details">Absolutely. We take the security and privacy of your personal
                                information very seriously. Our platform utilizes advanced encryption and security
                                protocols to safeguard your data.</div>
                        </div>
                        <div class="iq-ad-block"> <a href="javascript:void(0)" class="ad-title">Can I trade on
                                TradersEra from my mobile phone?</a>
                            <div class="ad-details">Yes, you can! We offer a user-friendly mobile trading app that
                                allows you to trade on the go from your smartphone or tablet.</div>
                        </div>
                        <div class="iq-ad-block"> <a href="javascript:void(0)" class="ad-title">What kind of support
                                does TradersEra offer?</a>
                            <div class="ad-details">We provide 24/7 customer support to assist you with any questions or
                                issues you may have. Our dedicated support team is here to help you every step of the
                                way.</div>
                        </div>
                        <div class="iq-ad-block"> <a href="javascript:void(0)" class="ad-title">How does artificial
                                intelligence (AI) factor into forex trading on TradersEra?</a>
                            <div class="ad-details">At TradersEra, we harness the power of AI to provide lightning-fast
                                trade execution, efficient processing, and advanced risk management tools. Our AI
                                algorithms analyze market data to identify patterns and trends, helping traders make
                                informed decisions.</div>
                        </div>
                        <div class="iq-ad-block"> <a href="javascript:void(0)" class="ad-title">What are Binary Options,
                                and how can I trade them on TradersEra?</a>
                            <div class="ad-details">Binary Options are financial instruments that allow traders to
                                speculate on the price movements of various assets. At TradersEra, you can trade Binary
                                Options on a range of assets including gold, oil, currencies, and more. With Binary
                                Options, you simply predict whether the price of an asset will rise or fall within a
                                specified time frame.</div>
                        </div>
                        <div class="iq-ad-block"> <a href="javascript:void(0)" class="ad-title">How does the deposit
                                process work on TradersEra, especially for local deposits?</a>
                            <div class="ad-details">Depositing funds into your TradersEra account is quick and easy. We
                                offer a variety of payment methods, including options for local deposits. Simply select
                                your preferred payment method and follow the instructions to initiate the deposit. If
                                you have any questions or need assistance, our support team is here to help you every
                                step of the way.</div>
                        </div>
                        <div class="iq-ad-block"> <a href="javascript:void(0)" class="ad-title">How long does it take to
                                process deposits and withdrawals?</a>
                            <div class="ad-details">Deposits are typically processed instantly, while withdrawals may
                                take slightly longer depending on the payment method you choose and any additional
                                verification requirements.</div>
                        </div>
                        <div class="iq-ad-block"> <a href="javascript:void(0)" class="ad-title">Can I practice trading
                                before risking real money?</a>
                            <div class="ad-details">Absolutely. We offer a demo account option that allows you to
                                practice trading with virtual funds before making any real investments.</div>
                        </div>
                        <div class="iq-ad-block"> <a href="javascript:void(0)" class="ad-title">Are there any hidden
                                fees or commissions?</a>
                            <div class="ad-details">No, we believe in transparency. We don't charge any hidden fees or
                                commissions. Our pricing is straightforward and competitive.</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row flex-row-reverse">
                    <div class="col-lg-6 align-self-center">
                        <div class="">
                            ...
                            <a href="video/01.html" class="iq-video popup-youtube"><i class="fa fa-play-outline"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-6 align-self-center mt-5 mt-lg-0">
                        <div class="heading-title left">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="heading-title">
                            ...
                            <h2 class="title">Ecosystem key features</h2>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="fancy-box">
                            <div class="heading">
                                <h4>Pre-Sale Stage 1</h4>
                                <p>15-1 May 2019</p>
                            </div>
                            <h5 class="iq-tw-7">1 Ethereum = REC150</h5>
                            <a href="#">40% bonus, 1 CoinEX ~ $14</a>
                            <h6>21, 000, 000 STMX</h6>
                    ...
                    <div class="col-lg-4 r9-mt-40">
                        <div class="fancy-box">
                            <div class="heading">
                                <h4>Pre-Sale Stage 2</h4>
                                <p>15-1 May 2019</p>
                            </div>
                            <h5 class="iq-tw-7">1 ETH = up to 41, 000 STMX</h5>
                            <a href="#">40% bonus, 1 CoinEX ~ $14</a>
                            <h6>21, 000, 000 STMX</h6>
                            <p>(up to $0.75 million)</p>
                        </div>
                    ...
                    <div class="col-sm-12 iq-mt-60">
                        <div class="heading-title">
                            <h2 class="title">Token Sale Proceeds</h2>
                            <p>Lorem Ipsum is simply dummy text ever sincehar the 1500s, when an unknownshil printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries.</p>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div id="chartrounddiv"></div>
                    </div>
                </div>
            </div>
        </section> -->
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="heading-title">
                            ...
                            <h2 class="title">Company Roadmap</h2>
                            <p>Lorem Ipsum is simply dummy text ever sincehar the 1500s, when an unknownshil printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="timeline-1">
                            <div class="timeline-t">
                                ...
                                <div class="timeline-content">
                                    <h5 class="text-white iq-tw-5">Rinks Cooper</h5>
                                    <span class="iq-font-yellow">Web Developer</span>
                                    <p class="iq-mt-10">
                            ...
                            <div class="timeline-t">
                                ...
                                <div class="timeline-content">
                                    <h5 class="text-white iq-tw-5">JD Scot</h5>
                                    <span class="iq-font-yellow">CoinEx</span>
                                    <p class="iq-mt-10">
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus mattis justo id pulvinar suscipit. Pellentesque rutrum vehicula erat sed dictum. Integer quis turpis magna. Suspendisse tincidunt elit at erat tincidunt, vel vulputate arcu dapibus. Etiam accumsan ornare posuere.
                                    </p>
                                </div>
                            ...
                            <div class="timeline-t">
                                ...
                                <div class="timeline-content">
                                    <h5 class="text-white iq-tw-5">Haris Morgan</h5>
                                    <span class="iq-font-yellow">CoinEx</span>
                                    <p class="iq-mt-10">
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus mattis justo id pulvinar suscipit. Pellentesque rutrum vehicula erat sed dictum. Integer quis turpis magna. Suspendisse tincidunt elit at erat tincidunt, vel vulputate arcu dapibus. Etiam accumsan ornare posuere.
                                    </p>
                            ...
                            <div class="timeline-t">
                                ...
                                <div class="timeline-content">
                                    <h5 class="text-white iq-tw-5">Nik Jorden</h5>
                                    <span class="iq-font-yellow">CoinEx</span>
                                    <p class="iq-mt-10">
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus mattis justo id pulvinar suscipit. Pellentesque rutrum vehicula erat sed dictum. Integer quis turpis magna. Suspendisse tincidunt elit at erat tincidunt, vel vulputate arcu dapibus. Etiam accumsan ornare posuere.
                                    </p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="heading-title">
                            <small class="iq-font-green">Features</small>
                            <h2 class="title">Tranding Platform</h2>
                            <p>Lorem Ipsum is simply dummy text ever sincehar the 1500s, when an unknownshil printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-6 align-self-center mt-5 mt-lg-0">
                        <h3 class="iq-mb-15">CoinEx:Token Usage</h3>
                        ...
                        <div class="iq-our-team-2 text-center">
                            <div class="team-blog mb-30">
                                ...
                                <div class="team-description">
                                    ...
                                    <div><a href="javascript:void(0)" class="text-white">support@qwilo.com</a></div>
                                </div>
                            ...
                            <h6 class="iq-mt-10"><a href="javascript:void(0)">Rinks Cooper</a></h6>
                            <p class="iq-mb-0">CEO, Qwilo</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 iq-mtb-15">
                        <div class="iq-our-team-2 text-center">
                            ...
                            <h6 class="iq-mt-10"><a href="javascript:void(0)">JD Scot</a></h6>
                            <p class="iq-mb-0">CEO, Qwilo</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 iq-mtb-15">
                        <div class="iq-our-team-2 text-center">
                            ...
                            <h6 class="iq-mt-10"><a href="javascript:void(0)">Haris Morgan</a></h6>
                            <p class="iq-mb-0">CEO, Qwilo</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 iq-mtb-15">
                        <div class="iq-our-team-2 text-center">
                            ...
                            <h6 class="iq-mt-10"><a href="javascript:void(0)">Nik Jorden</a></h6>
                            <p class="iq-mb-0">CEO, Qwilo</p>
                        </div>
                    </div>
                </div>
    ...
    <!-- <section class="overview-block-pb">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="heading-title">
                            <h2 class="title">Executive Advisor</h2>
                            <p>Lorem Ipsum is simply dummy text ever sincehar the 1500s, when an unknownshil printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="owl-carousel" data-autoplay="true" data-loop="true" data-nav="true" data-dots="false" data-items="3" data-items-laptop="3" data-items-tab="2" data-items-mobile="1" data-items-mobile-sm="1" data-margin="30">
                            <div class="item">
                                <div class="iq-blog-box">
                                    ...
                                    <div class="iq-blog-detail">
                                        <div class="blog-title"> <a href="#"><h5 class="iq-tw-7 iq-mb-10">Blogpost With HTML Video</h5> </a> </div>
                                        <div class="blog-content">
                            ...
                            <div class="item">
                                <div class="iq-blog-box">
                                    ...
                                    <div class="iq-blog-detail">
                                        <div class="blog-title"> <a href="#"><h5 class="iq-tw-7 iq-mb-10">Blogpost With Image</h5> </a> </div>
                                        <div class="blog-content">
                                            <p>Quae laboriosam sunt consectetur, assumenda provident lorem ipsum dolor sit amet, consectetur adipisicing elit. hic perspiciatis.</p>
                                        </div>
                                        <div class="iq-blog-meta">
                            ...
                            <div class="item">
                                <div class="iq-blog-box">
                                    ...
                                    <div class="iq-blog-detail">
                                        <div class="blog-title"> <a href="#"><h5 class="iq-tw-7 iq-mb-10">Blogpost With Vimeo</h5> </a> </div>
                                        <div class="blog-content">
                                            <p>Quae laboriosam sunt consectetur, assumenda provident lorem ipsum dolor sit amet, consectetur adipisicing elit. hic perspiciatis.</p>
                                        </div>
                                        <div class="iq-blog-meta">
                            ...
                            <div class="item">
                                <div class="iq-blog-box">
                                    ...
                                    <div class="iq-blog-detail">
                                        <div class="blog-title"> <a href="#"><h5 class="iq-tw-7 iq-mb-10">Blogpost With Audio</h5> </a> </div>
                                        <div class="blog-content">
                                            <p>Quae laboriosam sunt consectetur, assumenda provident lorem ipsum dolor sit amet, consectetur adipisicing elit. hic perspiciatis.</p>
                                        </div>
                                        <div class="iq-blog-meta">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="heading-title">
                            ...
                            <h2 class="title">Partners & Supporters</h2>
                            <p>Lorem Ipsum is simply dummy text ever sincehar the 1500s, when an unknownshil printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content blue-bg">
                ...
                <div class="modal-footer text-center">
                    <div> Don't Have an Account? <a href="javascript:void(0)" class="iq-font-yellow">Register Now</a>
                    </div>
    ...
    <script src="js/lib/particles1.min.js"></script>
