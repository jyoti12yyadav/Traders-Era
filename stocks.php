        ...
        <div class="row gy-6">
            <div class="col-lg-6 col-xxl-6">
                <div class="apply-card nb3-bg cus-rounded-1 py-5 py-lg-10 px-4 px-lg-9">
                    <h3 class="mb-4">Lower spreads</h3>
            ...
            <div class="col-lg-6 col-xxl-6">
                <div class="apply-card nb3-bg cus-rounded-1 py-5 py-lg-10 px-4 px-lg-9">
                    ...
                    <p>TradersEra is a regulated broker that applies raw spreads on most of its account types. With no
                        requotes, price manipulation, and restrictions, TradersEra stands strong in the market.
                    </p>
                </div>
            </div>
            <div class="col-lg-6 col-xxl-6">
                <div class="apply-card nb3-bg cus-rounded-1 py-5 py-lg-10 px-4 px-lg-9">
                    <h3 class="mb-4">Superior Trading Platform</h3>
                    <p>TradersEra believes in transfiguring Forex trading by allowing you direct access to the financial
                        market using the most preferred MT5 whitelabel trading platform.
                    </p>
                </div>
            </div>
            <div class="col-lg-6 col-xxl-6">
            ...
            <div class="col-lg-6 col-xxl-6">
                <div class="apply-card nb3-bg cus-rounded-1 py-5 py-lg-10 px-4 px-lg-9">
                    ...
                    <p>TradersEra is regulated in several jurisdictions and meets all strict financial standards as per
                        FCA ordinances, including capital adequacy requirements.
                    </p>
                </div>
            </div>
            <div class="col-lg-6 col-xxl-6">
                <div class="apply-card nb3-bg cus-rounded-1 py-5 py-lg-10 px-4 px-lg-9">
                    <h3 class="mb-4">Faster Execution</h3>
                    <p>TradersEra utilises enterprise-level hardware on its trade servers to ensure the lowest latency and
                        fastest trade execution only for you.
                    </p>
                </div>
            </div>
        </div>
...
<section class="testimonial-secondary te pt-120 pb-120 position-relative z-0">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                <div
                    class="swiper testimonial_swiper swiper-initialized swiper-horizontal swiper-pointer-events swiper-backface-hidden">
                    <div class="swiper-wrapper" id="swiper-wrapper-a20062faf9a3799d" aria-live="off"
                        style="transform: translate3d(-5344px, 0px, 0px); transition-duration: 2000ms;">
                        <div class="swiper-slide d-flex justify-content-center swiper-slide-duplicate swiper-slide-duplicate-next"
                            data-swiper-slide-index="4" role="group" aria-label="5 / 5"
                            style="width: 1296px; margin-right: 40px;">
                            <div class="col-lg-10 col-xl-8 col-xxl-6">
                                <div class="testimonial__par text-center">
                                    ...
                                    <div class="author_content">
                                        <p class=" fs-six-up mt-5 mt-xxl-6">"Trading has always been a passion, but it
                                            wasn't the lessons I learned along the way have been embraced
                                            riskinvaluable.</p>
                        ...
                        <div class="swiper-slide d-flex justify-content-center" data-swiper-slide-index="0" role="group"
                            aria-label="1 / 5" style="width: 1296px; margin-right: 40px;">
                            <div class="col-lg-10 col-xl-8 col-xxl-6">
                                <div class="testimonial__par text-center">
                                    <div class="author_thumbs">
                        ...
                        <div class="swiper-slide d-flex justify-content-center" data-swiper-slide-index="1" role="group"
                            aria-label="2 / 5" style="width: 1296px; margin-right: 40px;">
                            <div class="col-lg-10 col-xl-8 col-xxl-6">
                                <div class="testimonial__par text-center">
                                    <div class="author_thumbs">
                        ...
                        <div class="swiper-slide d-flex justify-content-center swiper-slide-prev"
                        ...
                        <div class="swiper-slide d-flex justify-content-center swiper-slide-next"
                            data-swiper-slide-index="4" role="group" aria-label="5 / 5"
                            style="width: 1296px; margin-right: 40px;">
                            <div class="col-lg-10 col-xl-8 col-xxl-6">
                                <div class="testimonial__par text-center">
                        ...
                        <div class="swiper-slide d-flex justify-content-center swiper-slide-duplicate"
                    ...
                    <div
                        class="swiper-pagination mt-8 mt-md-10 mt-lg-15 swiper-pagination-clickable swiper-pagination-bullets swiper-pagination-horizontal">
