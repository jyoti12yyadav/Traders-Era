    ...
    <div class="container mt-10 mt-lg-0 pt-15 pt-lg-20 pb-5 pb-lg-0">
        <div class="row">
            <div class="col-12 breadcrumb-area ">
                <h1 class="mb-4">CFD Partner</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                        <li class="breadcrumb-item ms-2 ps-7 active" aria-current="page"><span>CFD Partner</span>
                        </li>
                    </ol>
                </nav>
            </div>
...
<section class=" pt-120 pb-120">
                        ...
                        <div class="row gap-3 gap-sm-0">
                            <div class="col-sm-6 ">
                                <div class="single-input">
                                    ...
                                    <input type="text" class="fs-six-up" name="fname" placeholder=""
                                        required="">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="single-input">
                                    ...
                                    <input type="text" class="fs-six-up" name="lname" placeholder=""
                                        required="">
                                </div>
                            </div>
                        </div>
                        <div class="row gap-3 gap-sm-0">
                            ...
                            <div class="col-sm-6">
                                <div class="single-input">
                                    ...
                                    <input type="tel" class="fs-six-up" name="phone" placeholder=""
                                        required="">
                                </div>
                            </div>
                        </div>
  ...
  <option value="Zimbabwe">Zimbabwe</option>
                        ...
                        <div class="row gap-3 gap-sm-0 ">
                            <div class="col-sm-12">
                                <div class="single-input">
                                    ...
                                    <input type="number" class="fs-six-up" name="client-average-volume"
                                        placeholder="" required="">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="single-input">
                                    ...
                                    <input type="text" class="fs-six-up" name="legacyfx"
                                        placeholder="" required="">
                                </div>
                            </div>
                        </div>
                        <div class="input-single">
                            ...
                            <textarea class="fs-six-up" name="message" rows="4" placeholder=""
                                required=""></textarea>
                        </div>
                    </div>
                    <span id="msg"></span>
