...
<head>
    ...
    <title>Ranchi Forex | Ranchi Forex Trade | Ranchi Forex Trading App</title>
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta name="description"
        content="Easily trade Forex in Ranchi with TradersEra's MT5 and UTIP platform." />
    <meta name="keywords"
        content="Ranchi Forex, Online Forex Trading, MT5, Meta Trader 5, UTIP Trading Platform, Become a Partner, forex ib program, Best Forex Broker,
         ...
         Ranchi Forex Exchange, Ranchi Forex Trading App, Ranchi Forex Trade " />
    <!-- Favicon -->
                ...
                <div class="row justify-content-md-center">
                    ...
                    <div class="col-lg-12 text-center">
                        <div class="iq-countdown">
                            <h2 class="text-white">Easy To Use All In One Platform With Low Amount Deposit
                            </h2>
                            <br><br>
                            <p>Hey Ranchi, TradersEra has got you covered Dive into a world of possibilities with our
                                user-friendly platform. Low starting amounts, high leverage, and top-notch security
                                await you. Let's kickstart your journey to financial success today
                            </p>
        ...
        <div class="banner-info">
            <div class="container">
                <div class="row justify-content-md-center">
                    ...
                    <div class="col-lg-12 text-center">
                        <div class="iq-countdown">
                            <p>Don't miss out on this opportunity Join TradersEra as an Introducing Broker and unlock
                                your earning potential. Let's make waves in Ranchi together
                            </p>
                            <!-- <h5>Get Access to a Range of Trading Options with Just a Minimum Deposit!</h5> -->
                            <br>
                        </div>
