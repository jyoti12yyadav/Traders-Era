        ...
        <div class="container ">
            <div class="row align-items-center justify-content-center justify-content-xl-start">
                <div class="col-12 col-sm-10 col-md-6">
                    <div class="welcome alt-color text-center text-md-start pt-120 pb-120 position-relative z-0">
                        ...
                        <div class=" mt-7 mt-lg-4">
                            <button href="webtraders.tradersera.com"  type="submit" class="cmn-btn cmn-btn2 py-3 px-5 px-lg-6 mt-7 mt-lg-8 w-50 d-center" name="submit" id="submit" style="--top: 43px; --left: 301px;background-color: rgb(0 0 0);color: #ffffff;">Start Trading</button>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-5 col-xxl-6 offset-xxl-1 text-center ms-xl-auto mx-auto">
                    ...
                    <div class="welcome alt-color text-center text-md-start pt-120 pb-120 position-relative z-0" style="padding-left: 70px;">
                       
                        <h1 class="display-one" style="color: #9ad953;">I want to Trade on Binary</h1>
                        <div class=" mt-7 mt-lg-4">
                            <button href="https://trading.tradersera.com" type="submit" class="cmn-btn py-3 px-5 px-lg-6 mt-7 mt-lg-8 w-50 d-center" name="submit" id="submit" style="--top: 43px; --left: 301px;">Start Trading</button>
                        </div>
                    </div>
                </div>
            </div>
