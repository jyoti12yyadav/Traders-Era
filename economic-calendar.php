            ...
            <div class="col-12 breadcrumb-area ">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item ms-2 ps-7 active" aria-current="page"><span>Economic Calender</span></li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 col-xxl-12">
                ...
                <h2 class="d-flex justify-content-center" style="margin-bottom: 30px;">Stay Ahead with TradersEra's Economic Calendar</h2>
