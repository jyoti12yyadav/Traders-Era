        ...
        <div class="row gy-6 gy-xxl-0">
            <center>
                ...
                <span class="mb-10">It's a simple process to follow. The more friends you invite, the more money you can
                    earn. There's no limit to the number of friends you can refer to</span>
            </center>
            ...
            <div class="col-md-6 col-xxl-4">
                <div class="provide-world__card secondary nb3-bg text-center cus-rounded-1 py-5 py-lg-10 px-4 px-lg-9">
                    ...
                    <h4 class="mt-5 mb-5">Reward Yourself for Referrals
                    </h4>
                </div>
            </div>
            <div class="col-md-6 col-xxl-4">
                <div class="provide-world__card secondary nb3-bg text-center cus-rounded-1 py-5 py-lg-10 px-4 px-lg-9">
                    ...
                    <h4 class="mt-5 mb-5">Trade & Take Out Your Profits 
                    </h4>
                </div>
            </div>
        </div>
        ...
        <div class="row gy-6 gy-xxl-0">
            ...
            <div class="col-md-6 col-xxl-4">
                <div class="provide-world__card secondary nb3-bg text-left cus-rounded-1 py-5 py-lg-10 px-4 px-lg-9">
                    ...
                    <p class="mt-5 mb-5">Share your link everywhere now</p>
                </div>
            </div>
            <div class="col-md-6 col-xxl-4">
                <div class="provide-world__card secondary nb3-bg text-left cus-rounded-1 py-5 py-lg-10 px-4 px-lg-9">
                    ...
                    <h4 class="mt-5 mb-5">Receive 50% of your friends deposit
                    </h4>
                    <p class="mt-5 mb-5">You will receive 50% of your referred clients
                   </p>
                </div>
            </div>
            <section class="provide-world pt-120 pb-100  position-relative z-0" style="padding: bottom 25px;">
    <div class="container">
        <div class="row gy-6 gy-xxl-7">
...
Visit TradersEra with loved ones, coworkers, and friends, and take pleasure in watching your balance increase.
            ...
            <div class="col-md-6 col-xxl-4">
                <div class="provide-world__card secondary nb3-bg text-left cus-rounded-1 py-5 py-lg-10 px-4 px-lg-9">
                    ...
                    <h4 class="mt-5 mb-5">Increase your balance by trading and increasing it!
                    </h4>
                    <!-- <p class="mt-5 mb-5">Share your link everywhere now</p> -->
                </div>
            </div>
                        ...
                        <div class="accordion-single  cus-rounded-1 nb3-bg box-shadow py-3 py-md-4 px-4 px-md-5">
                            <h3 class="header-area">
                                <button
                                    ...
                                    type="button"> How would one ask a friend?</button>
                            </h3>
                            <div class="content-area">
                                <div class="content-body pt-5">
                                    <p>By asking your friends to join us, you may simply earn an extra 50% through our referral program.
...
You'll get paid 50% of each deposit your referrer makes on our platform when he joins up and completes a deposit.
                        ...
                        <div class="accordion-single cus-rounded-1 nb3-bg box-shadow py-3 py-md-4 px-4 px-md-5">
                            ...
                            <div class="content-area">
                                <div class="content-body pt-5">
                                    <p>As soon as your referrals make deposits, referral earnings are promptly applied to the amount of your referral account.As soon as your referrals make deposits, referral earnings are promptly applied to the amount of your referral account.
Simply navigate to your account's "Invite a Friend" area to view your profits, which you may transfer to your trading balance whenever you'd like.
</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-single cus-rounded-1 nb3-bg box-shadow py-3 py-md-4 px-4 px-md-5">
                            <h3 class="header-area">
                                <button
                                    class="accordion-btn transition fw-semibold text-start d-flex position-relative w-100"
                                    type="button">
                                    With our referral program, is it feasible to earn a bigger percentage?
                                </button>
                            </h3>
                            <div class="content-area">
                                <div class="content-body pt-5">
                                    <p>Yes, indeed! It is very feasible to receive a commission from clients you have recommended that is greater than 20%.

Simply send an email to support@tradersera.com to get in touch with our helpful support staff to find out more and discuss the increased commission rates.
</p>
                                </div>
                            </div>
                        </div>
...
What are the boundaries?
                            ...
                            <div class="content-area">
                                <div class="content-body pt-5">
                                    <p>The earning potential with our referral program is virtually endless!
You may continuously bring in more money as long as you keep referring new customers.
</p>
                                </div>
                            </div>
                        </div>
