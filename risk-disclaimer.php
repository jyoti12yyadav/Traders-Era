    ...
    <div class="container mt-lg-0 pt-18 pt-xl-20">
        <div class="row">
            <div class="col-12 breadcrumb-area ">
                <h2 class="mb-4">Risk Disclaimer</h2>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                        <li class="breadcrumb-item ms-2 ps-7 active" aria-current="page"><span>Risk Disclaimer</span>
                        </li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10 col-xxl-8">
                <div class="nb3-lg-bg pb-0 pb-md-4 p-4 p-sm-10 p-lg-15 cus-rounded-2">
                    <h2 class="text-center mb-10 mb-lg-15">Risk Disclaimer</h2>
                    <div class="privacy-policy__card d-flex flex-column gap-8 gap-lg-10">
                        <div class="privacy-policy__part">
                            ...
                            <p class="mt-3">Prospective clients should study the below-mentioned risk warnings very
                                ...
                                Equities). We simply outline the general nature of the risks of dealing in Financial
                                Instruments on a fair and non-misleading basis.</p>
                            <p class="mt-3">In particular, Contracts for Difference (‘CFDs’) are complex financial
                                products and not suitable for all investors. CFDs are leveraged products that mature
                                when you choose to close an existing open position. By investing in CFDs, you assume a
                                high level of risk and can result in the loss of all of your invested capital.</p>
                            <p class="mt-3">Unless a client knows and fully understands the risks involved in each
                                Financial Instrument, they should not engage in any trading activity. You should not
                                risk more than you are prepared to lose. EndureFX will not provide clients with any
                                investment advice in relation to investments, possible transactions in investments, or
                                Financial Instruments, neither will we make any investment recommendations. Clients
                                should consider which Financial Instrument is suitable for them according to their
                                financial status and goals before opening an account with EndureFX. If a client is
                                unclear about the risks involved in trading in Financial Instruments, then they should
                                consult an independent financial advisor. If the client still doesn’t understand these
                                risks after consulting an independent financial advisor, then they should refrain from
                                trading at all. Purchasing and selling Financial Instruments comes with a significant
                                risk of losses and damages and each client must understand that the investment value can
                        ...
                        <div class="privacy-policy__part">
                            ...
                            <h6>Technical Risk</h6>
                            <p class="mt-4 mb-5">The Client shall be responsible for the risks of financial losses
                                caused by the failure of information, communication, electronic and other systems. The
                                result of any system failure may be that his order is either not executed according to
                                his instructions or it is not executed at all. EndureFX does not accept any liability in
                                case of such a failure.</p>
                            <p class="mt-4 mb-5"> While trading through the Client Terminal, the Client shall be
                                responsible for the risks of financial losses caused by:</p>
                            <ul class="ul-decimal mt-5 d-flex gap-3 flex-column">
                                <li>Client’s or Company’s hardware or software failure, malfunction or misuse.</li>
                                <li>Poor Internet connection either on the Client side or EndureFX side or both, or
                                    interruptions or transmission blackouts or public electricity network failures or
                                    hacker attacks, overload of connection</li>
                                <li> Wrong settings in the Client Terminal.</li>
                                <li>Delayed Client Terminal updates.</li>
                                <li>Client disregarding the applicable rules described in the Client Terminal user guide
                                    and in EndureFX Website.</li>
                            </ul>
                        ...
                        <div class="privacy-policy__part">
                            ...
                            <ul class="ul-decimal mt-5 d-flex gap-3 flex-column">
                                <li>The Client acknowledges that only one Request or Instruction is allowed to be in the
                                    queue at one time. Once the Client has sent a Request or an Instruction, any further
                                    Requests or Instructions sent by the Client are ignored and the “Order is locked”
                                    message appears until the first Request or Instruction is executed.</li>
                                <li>The Client acknowledges that the only reliable source of Quotes Flow information is
                                    that of the real/live Server’s Quotes Base. Quotes Base in the Client Terminal is
                                    not a reliable source of Quotes Flow information because the connection between the
                                    Client Terminal and the Server may be disrupted at some point and some of the Quotes
                                    simply may not reach the Client Terminal.</li>
                                <li>The Client acknowledges that when the Client closes the order
                                    placing/modifying/deleting window or the position opening/closing window, the
                                    Instruction or Request, which has been sent to the Server, shall not be cancelled.
                                </li>
                                <li>In case the Client has not received the result of the execution of the previously
                                    sent Instruction but decides to repeat the Instruction, the Client shall accept the
                                    risk of making two Transactions instead of one, however the client may receive an
                                    “Order is locked” message as described above.</li>
                                <li>The Client acknowledges that if the Pending Order has already been executed but the
                                    Client sends the Instruction to modify its level and the levels of If-Done Orders at
                                    the same time, the only Instruction, which will be executed, is the Instruction to
                                    modify Stop Loss and/or Take Profit levels on the position opened when the Pending
                                    Order triggered.</li>
                            </ul>
                        </div>
                        ...
                        <div class="privacy-policy__part">
                            ...
                            <ul class="ul-decimal mt-5 d-flex gap-3 flex-column">
                                <li>The Client shall accept the risk of any financial losses caused by the fact that the
                                    Client has received with delay or has not received at all any notice from EndureFX.
                                </li>
                                <li>The Client acknowledges that the unencrypted information transmitted by email is not
                                    protected from any unauthorised access.</li>
                                <li>The Client is fully responsible for the risks in respect of undelivered trading
                                    platform internal mail messages sent to the Client by EndureFX as they are
                                    automatically deleted within 3 (three) calendar days.</li>
                                <li>The Client is fully responsible for the privacy of the information received from
                                    EndureFX and accepts the risk of any financial losses caused by the unauthorised
                                    access of a third party to the Client’s Trading Account.</li>
                                <li>EndureFX has no responsibility if authorized/unauthorised third persons have access
                                    to information, including electronic addresses, electronic communication and
                                    personal data, access data when the above are transmitted between EndureFX or any
                        ...
                        <div class="privacy-policy__part">
                            ...
                            <p class="mt-4 mb-5">This notice cannot disclose all the risks and other significant aspects
                                ...
                                and the extent of your exposure to risk. You should also be satisfied that the product
                                is suitable for you in light of your circumstances and financial position. Certain
                                strategies, such as a “spread” position or a “straddle”, may be as risky as a simple
                                Long or Short position.</p>
                            <p class="mt-4 mb-5">Although forex and derivative instruments can be used for the
                                management of investment risk, some of these products are unsuitable for many investors.
                                You should not engage in any dealings directly or indirectly in derivative products
                                unless you know and understand the risks involved in them and that you may lose entirely
                        ...
                        <div class="privacy-policy__part">
                            ...
                            <p class="mt-4 mb-5">Under Margin Trading conditions even small market movements may have a
                                ...
                                against the Client, the Client may sustain a total loss greater than the funds
                                deposited. The Client is responsible for all the risks, financial resources the Client
                                uses and for the chosen trading strategy.</p>
                            <p class="mt-4 mb-5">It is highly recommended that the Client maintains a Margin Level
                                (percentage Equity to Necessary Margin ratio which is calculated as Equity / Necessary
                                Margin * 100%) of not lower than 1,000%. It is also recommended to place Stop Loss to
                                limit potential losses, and Take Profit to collect profits, when it is not possible for
                                the Client to manage the Client’s Open Positions.</p>
                            <p class="mt-4 mb-5"> The Client shall be responsible for all financial losses caused by the
                                opening of the position using temporary excess Free Margin on the Trading Account gained
                                as a result of a profitable position (cancelled by EndureFX afterwards) opened at an
                        ...
                        <div class="privacy-policy__part">
                            ...
                            <p class="mt-4 mb-5">Some Instruments trade within wide intraday ranges with volatile price
                                ...
                                the price of the underlying asset in which the instruments refer to (for example
                                currency, stock, metals, indices, etc). Derivative financial instruments and related
                                ...
                                in conditions, none of which can be controlled by the Client or EndureFX.
                            ...
                            <p class="mt-4 mb-5">Under certain market conditions it may be impossible for a Client’s
                                ...
                                the underlying asset will be influenced by, amongst other things, changing supply and
                                demand relationships, governmental, agricultural, commercial and trade programs and
                            ...
                            <p class="mt-4 mb-5">The Client acknowledges and accepts that, regardless of any information
                                which may be offered by EndureFX, the value of Instruments may fluctuate downwards or
                                upwards and it is even probable that the investment may become of no value. This is owed
                                to the margining system applicable to such trades, which generally involves a
                        ...
                        <div class="privacy-policy__part">
                            ...
                            <p class="mt-4 mb-5">Transactions in futures involve the obligation to make, or to take,
                                ...
                                often obtainable in futures trading means that a small deposit or down payment can lead
                                to large losses as well as gains. It also means that a relatively small movement can
                                lead to a proportionately much larger movement in the value of your investment, and this
                        ...
                        <div class="privacy-policy__part">
                            ...
                            <p class="mt-4 mb-5">If you write an option, the risk involved is considerably greater than
                                ...
                                legal obligation to purchase or sell the underlying asset if the option is exercised
                                against you, however far the market price has moved away from the exercise price. If you
                                already own the underlying asset which you have contracted to sell (when the options
                                will be known as covered call options) the risk is reduced. If you do not own the
                        ...
                        <div class="privacy-policy__part">
                            ...
                            <p class="mt-4 mb-5">The CFDs available for trading with EndureFX are non-deliverable spot
                                transactions giving an opportunity to make profit on changes in currency rates,
                                commodity,
                                stock market indices or share prices called the underlying instrument. </p>
                            <p class="mt-4 mb-5">If the underlying instrument movement is in the Client’s favour, the
                                Client
                                may achieve a good profit, but an equally small adverse market movement can not only
                                quickly
                                result in the loss of the Client’s entire deposit but also any additional
                                table-accordion
                                commissions and other expenses incurred. So, the Client must not enter into CFDs unless
                                he
                                is willing to undertake the risks of losing entirely all the money which he has invested
                                and
                                also any additional table-accordion commissions and other expenses incurred.</p>
                            <p class="mt-4 mb-5">
                                Investing in a Contract for Differences carries the same risks as investing in a future
                                or
                                an option and you should be aware of these as set out above. Transactions in Contracts
                                for
                        ...
                        <div class="privacy-policy__part">
                            ...
                            <p class="mt-4 mb-5">Shares are bought and sold on stock exchanges and their values can go
                                down. In
                                respect of shares in smaller companies, there is an extra risk of losing money when such
                                shares
                                are bought or sold. There can be a big difference between the buying and selling price
                                of these
                                shares.
                                If they have to be sold immediately, the Clients may get back much less than they paid
                                for them.
                                Shares in companies incorporated in emerging markets may be harder to buy and sell than
                                those
                                shares in companies in more developed markets and such companies may also not be
                                regulated as
                                strictly.</p>
                            <p class="mt-4 mb-5">All Equities offered are listed on an exchange, which means that the
                                prices are
                                not set by EndureFX. EndureFX will act on any instruction that the Client provides to
                                buy or
                                sell an instrument on his/her behalf in accordance with EndureFX obligation to provide
                                best
                            ...
                            <p class="mt-4 mb-5">EndureFX may place the Client’s instructions to deal outside of an
                                exchange if
                                this is in line with the order execution policy.

                            </p>

                            <p class="mt-4 mb-5">EndureFX will arrange for the custody of the Clients instruments.
                                All equities purchased for the Client or transferred to EndureFX by the Client, will be
                                purchased in the name of the nominee company or EndureFX, and/or held by a nominee
                                company
                                selected by EndureFX, for the benefit of the Client.
                                As investments will be held in the name of a nominee company, the Client may not have
                                voting
                            ...
                            <p class="mt-4 mb-5">The risks that the Clients are exposed to will vary according to the
                                instruments they instruct EndureFX to buy and sell on their behalf.
                            ...
                            <p class="mt-4 mb-5">EndureFX services are provided on an execution only basis. EndureFX
                                does not
                                provide investment advice in relation to Equities. EndureFX might provide factual
                                information or
                        ...
                        <div class="privacy-policy__part">
                            ...
                            <p class="mt-4 mb-5">When Clients enter into the Collateral Agreement with EndureFX, it is
                                ...
                                and fall. If the collateral value of the assets in Clients Share Account, together with
                                any cash on Client’s linked CFD Account, falls below the amount required to maintain the
                                open positions, Client may be closed out of the CFD positions on that linked account,
                                and EndureFX will have the right to sell the assets in the Client’s Share Account in
                        ...
                        <div class="privacy-policy__part">
                            ...
                            <p class="mt-4 mb-5">CFDs, forex, and precious metals are off-exchange transactions. While
                                ...
                                derivatives because there is no exchange market on which to close out an Open Position.
                                It may be impossible to liquidate an existing position, to assess the value of the
                            ...
                            <p class="mt-4 mb-5">In regards to transactions in CFDs, forex, and precious metals with
                                EndureFX, EndureFX is using a trading platform for transactions in CFDs which does not
                        ...
                        <div class="privacy-policy__part">
                            ...
                            <p class="mt-4 mb-5">Foreign markets involve various risks. On request, EndureFX must
                        ...
                        <div class="privacy-policy__part">
                            ...
                            <p class="mt-4 mb-5">It is noted that EndureFX will not have a duty to notify the Client for
                        ...
                        <div class="privacy-policy__part">
                            ...
                            <p class="mt-4 mb-5">If you deposit collateral as security with EndureFX, the way in which
                                ...
                                depending on whether you are trading on a recognised or designated investment exchange,
                                with the rules of that exchange (and the associated clearing house) applying, or trading
                                off-exchange. Deposited collateral may lose its identity as your property once dealings
                        ...
                        <div class="privacy-policy__part">
                            ...
                            <p class="mt-4 mb-5">There is a risk that the Client’s trades in any Financial Instruments
                                ...
                                for example because of changes in legislation or his personal circumstances. EndureFX
                            ...
                            <p class="mt-4 mb-5">The Clients are responsible for managing their tax and legal affairs
                                ...
                                and regulations. EndureFX does not provide any regulatory, tax or legal advice. If the
                                Clients are in any doubt as to the tax treatment or liabilities of investment products
                                available through EndureFX, they should seek independent advice.</p>
                        ...
                        <div class="privacy-policy__part">
                            ...
                            <p class="mt-4 mb-5">On request, EndureFX must explain any protection provided to you under the clearing guarantee applicable to any on-exchange derivatives in which you are dealing. There is no clearing house for traditional options, nor normally for off-exchange instruments which are not traded under the rules of a recognised or designated investment exchange.</p>
                        ...
                        <div class="privacy-policy__part">
                            ...
                            <p class="mt-4 mb-5">EndureFX insolvency or default, may lead to positions being liquidated or closed out without your consent. In certain circumstances, you may not get back the actual assets which you lodged as collateral and you may have to accept any available payments in cash or by any other method deemed to be appropriate. </p>

                            <p class="mt-4 mb-5">Segregated Funds will be subject to the protections conferred by Applicable Regulations.</p>

                            <p class="mt-4 mb-5">Non-segregated Funds will not be subject to the protections conferred by Applicable Regulations. Non-segregated Funds will not be segregated from EndureFX money and will be used in the course of EndureFX business, and in the event of EndureFX insolvency you will rank as a general creditor.</p>

                         
                        </div>
                        <div class="privacy-policy__part">
                            <h5 class="mb-4">4. Third Party Risk</h5>
                            <h6>This notice is provided to you in accordance with applicable legislation.</h6>
                            <p class="mt-4 mb-5">EndureFX may pass money received from the Client to a third party (e.g. a bank, a market, intermediate broker, OTC counterparty or clearing house) to hold or control in order to effect a Transaction through or with that person or to satisfy the Client ‘s obligation to provide collateral (e.g. initial margin requirement) in respect of a Transaction. EndureFX has no responsibility for any acts or omissions of any third party to whom it will pass money received from the Client.</p>
                            <p class="mt-4 mb-5">The third party to whom EndureFX will pass money may hold it in an omnibus account and it may not be possible to separate it from the Client ‘s money, or the third party’s money. In the event of the insolvency or any other analogous proceedings in relation to that third party, EndureFX may only have an unsecured claim against the third party on behalf of the Client, and the Client will be exposed to the risk that the money received by EndureFX from the third party is insufficient to satisfy the claims of the Client with claims in respect of the relevant account. EndureFX  does not accept any liability or responsibility for any resulting losses.</p>
                            <p class="mt-4 mb-5">EndureFX may deposit Client money with a depository who may have a security interest, lien or right of set-off in relation to that money.</p>
                            <p class="mt-4 mb-5">A Bank or Broker through whom EndureFX deals with could have interests contrary to the Client’s interests.</p>
