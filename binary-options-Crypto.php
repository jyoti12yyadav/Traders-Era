    ...
    <div class="container mt-10 mt-lg-0 pt-15 pt-lg-20 pb-5 pb-lg-0">
        <div class="row">
            <div class="col-12 breadcrumb-area ">
                <h2 class="mb-4">Binary Options - Crypto</h2>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                        <li class="breadcrumb-item ms-2 ps-7 active" aria-current="page"><span>Binary Options -
                                Crypto</span></li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="row gy-10 gy-xxl-0 justify-content-center justify-content-xxl-between align-items-center">
            ...
            <div class="col-md-10 col-lg-6 col-xxl-5">
                ...
                <ul class="d-flex gap-4 flex-column mt-6">
                    ...
                    <li class="d-flex align-items-center gap-3 fs-six-up"><i
                            class="ti ti-circle-check s1-color fs-four"></i>Quick money withdrawal.
                    </li>
                    <li class="d-flex align-items-center gap-3 fs-six-up"><i
                ...
                <div class="faq__part">
                    <div class="accordion-section d-grid gap-6">
                        <div class="accordion-single  cus-rounded-1 nb3-bg box-shadow py-3 py-md-4 px-4 px-md-5">
                            ...
                            <div class="content-area">
                                <div class="content-body pt-5">
                                    <p>By asking your friends to join us, you may simply earn an extra 50% through our
                                        referral program.
                                        This is how it operates: Just sign in to your account, visit our Trading page,
                                        and select the 'Invite a friend' tab from the
                                        menu on the left.
                                        Share your special referral link with your friends by copying it.
                                        You'll get paid 50% of each deposit your referrer makes on our platform
                                        when he joins up and completes a deposit.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-single cus-rounded-1 nb3-bg box-shadow py-3 py-md-4 px-4 px-md-5">
                            ...
                            <div class="content-area">
                                <div class="content-body pt-5">
                                    <p>As soon as your referrals make deposits, referral earnings are promptly applied
                                        to the amount of your referral account.
                            ...
                            <div class="content-area">
                                <div class="content-body pt-5">
                                    <p>The earning potential with our referral program is virtually endless!
                                        You may continuously bring in more money as long as you keep referring<br /> new
                                        customers.
                                    </p>
                                </div>
                            </div>
