...
.provide-world__card:hover {
    background-color: rgb(31,31,31) !important; /* Removes the green background color on hover */
}
        ...
        <div class="row gy-10 gy-xxl-0 justify-content-center justify-content-xxl-between align-items-center">
            <div class="col-lg-6 col-xxl-5">
                <div class="trade_on__content">
                    ...
                    <p class="fs-six mx-ch">TradersEra brings you a robust trading app with a variety of features that allow you to personalize settings based 
                        on your preferences,
